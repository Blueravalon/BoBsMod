...
{
    public class peanut : ModMenu
    {
        public override string DisplayName => "BoB's Mod";
        ...
        public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/'78");
        ...
        public override bool PreDrawLogo(SpriteBatch spriteBatch, ref Vector2 logoDrawCenter, ref float logoRotation, ref float logoScale, ref Color drawColor)
        {
            ...
            Texture2D blackTexture = ModContent.Request<Texture2D>("broilinghell/bobground").Value;
