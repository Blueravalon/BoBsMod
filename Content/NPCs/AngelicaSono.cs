...
namespace broilinghell.Content.NPCs
{
    public class AngelicaSono : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.value = 60f;
            NPC.knockBackResist = 0.2f; // Reduced knockback resistance for flying boss
