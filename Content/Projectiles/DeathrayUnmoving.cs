...
{
    public class DeathrayUnmoving : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                float rotationSpeed = 0f; // Increased from 0.015f
        ...
        private void CreateEnhancedDustEffects()
        {
            ...
            if (Main.rand.NextBool(1))
            {
                for (int i = 0; i < laserLength; i += 40)
                {
                    ...
                    int dustType = Main.rand.Next(new int[] { DustID.Electric, DustID.GreenTorch, DustID.Terra, DustID.Electric});
